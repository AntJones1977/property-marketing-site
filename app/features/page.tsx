    ...
    features: [
      {
        ...
        bullets: [
          ...
          'Every expense item grouped under the actual SA105 line it reports on',
          'One merged dataset — summary table, headline cards, property detail, accountant email and exports all read the same figures; where live records and a projection disagree, the app says so',
      ...
      },
      {
        ...
        bullets: [
          ...
          'Fills the real HMRC SA903 flat PDF — text overlaid at calibrated (x, y) coordinates via pdf-lib, now calibrated across four tax years including HMRC’s 2025-26 redesign',
      ...
      },
      {
        ...
        bullets: [
          ...
          'Smart fallback when the OCR date looks wrong',
          'Auto-merge of confirmed expenses onto the correct SA105 line — professional fees, insurance and other categories land where they belong, not dumped into Repairs',
          'AI PDF bank-statement extraction — a scanned statement becomes reviewable transactions',
    ...
    features: [
      ...
      },
      {
        ...
        bullets: [
          ...
          '"Correct the transfer date" repair tool if an ownership boundary was mis-recorded — the personal and company slices of a transfer year always partition exactly',
  ...
  },
  {
    ...
    features: [
      ...
      },
      {
        ...
        bullets: [
          'Two-way — tenants compose from the portal; landlords read, filter and reply from /messages with one-click Reply',
          'Per-property threaded conversations',
          'Email alerts on new tenant messages',
          'Tenant-event notifications fan out over email and Twilio SMS to nominated recipients',
      ...
      },
      {
        ...
        bullets: [
          ...
          'Receipt lifecycle done right — scanned receipts confirm automatically on assignment; the Receipts page shows only real receipts (never bank-feed noise), with draft badges, month accordions and bulk confirm',
          'Large receipt uploads direct-to-storage — a big photo never hits a size cliff, and every failure shows a readable reason',
          'Warns when a receipt’s date lands in a different tax year from the work',
    ...
    features: [
      ...
      },
      {
        ...
        bullets: [
          ...
          'Late-rent surface — instantly see who is behind',
          'Not-yet-purchased properties excluded from every tax figure and always named in an exclusion note — never silently hidden',
          'Mortgage renewal alerts with countdown',
          'Portfolio summary PDF export + rent-roll and rent-schedule exports (per-property and whole-portfolio, month-by-month, CSV and PDF)',
    ...
    features: [
      ...
      },
      {
        ...
        bullets: [
          ...
          'Email or username login, on a custom domain with SSL',
          'Fail-closed webhooks and server-side guards that stop a client injecting figures straight onto a tax return',
