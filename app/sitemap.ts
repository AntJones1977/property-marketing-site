...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const routes = [
    ...
    '/guides/capital-gains-tax-rental-property',
    '/guides/epc-mees-energy-standards',
    '/guides/tenancy-deposit-protection',
    '/guides/right-to-rent-checks',
    '/guides/inheritance-tax-property-portfolio',
    '/guides/selective-licensing',
    '/guides/section-8-possession-grounds',
    '/guides/landlord-insurance-rent-guarantee',
